...
alias copec-vi='vi ~/.aws/credentials'
alias winconect='rdesktop-vrdp -d e-copec -u admin_fsae disk:~/Trabajo -g 1800x1000'
alias yoda='ssh 10.40.7.17 -l root'
alias c3p0='ssh 10.40.7.7 -l root'
alias sith='ssh 10.40.7.26 -l root'
...
. "$HOME/.cargo/env"
source /home/byron/Descargas/alacritty/extra/completions/alacritty.bash
